            ...
            <ul class="mb-0">
                <li class="pb-7">
                    <div class="d-flex align-items-center">
                        <img src="{{ asset('dist/images/products/product-1.jpg') }}" width="95"
                ...
                <li class="pb-7">
                    <div class="d-flex align-items-center">
                        <img src="{{ asset('dist/images/products/product-2.jpg') }}" width="95"
                            height="75" class="rounded-1 me-9 flex-shrink-0" alt="" />
                        <div>
                            <h6 class="mb-1">Supreme toys cooker</h6>
                            <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                ...
                <li class="pb-7">
                    <div class="d-flex align-items-center">
                        <img src="{{ asset('dist/images/products/product-3.jpg') }}" width="95"
                            height="75" class="rounded-1 me-9 flex-shrink-0" alt="" />
                        <div>
                            <h6 class="mb-1">Supreme toys cooker</h6>
                            <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
            ...
            <div class="theme-option pb-4">
                ...
                <div class="d-flex align-items-center gap-3 my-3">
                    ...
                    <a href="javascript:void(0)"
                        onclick="toggleTheme('{{ asset('dist/css/style-dark.min.css') }}')"
                    ...
                    <ul class="list-unstyled mb-0 d-flex gap-3 flex-wrap change-colors">
                        <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('dist/css/style.min.css') }}')" data-color="blue_theme"
                        ...
                        <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('dist/css/style-aqua.min.css') }}')" data-color="aqua_theme"
                        ...
                        <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('dist/css/style-purple.min.css') }}')" data-color="purple_theme"
                        ...
                        <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('dist/css/style-green.min.css') }}')" data-bs-toggle="tooltip"
                        ...
                        <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('dist/css/style-cyan.min.css') }}')" data-bs-toggle="tooltip"
                        ...
                        <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('dist/css/style-orange.min.css') }}')" data-bs-toggle="tooltip"
